...
function get20s(array2){
  ...
  for(let i=0;i<array2.length;i++){
    if(array2[i].years.includes('190')){
    newArray11.push(array2[i].name);
    }
  }return newArray11;
}
get20s(artists);
...
function removeArtist(array3,numberIndex){
  let newArray = [...array3];
  newArray.splice(numberIndex,1);
...
function lotsOfArt(array5){
  ...
  for(let i=0;i<array5.length;i++){
    if(array5[i].paintings >= 100){
    newArray2.push(array5[i].name);
    }
  }return newArray2;
}
lotsOfArt(artists);
